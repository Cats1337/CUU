...
public class doom_chestplate extends UberItem {
//    Doom Chestplate
//    Netherite Chestplate - Curse Of Binding, Protection 5, Unbreakable and Mending
//    While wearing grants the player strength 2
...
//    Once picked up is equiped immediately swapping with current armor player is wearing
    public doom_chestplate(Material material, String name, UberRarity rarity, boolean stackable, boolean oneTimeUse, boolean hasActiveEffect, List<UberAbility> abilities, UberCraftingRecipe craftingRecipe) {
