...
public class golden_carrot_bucket extends UberItem {
//    Bucket Of Golden Carrots
//      Re-usable Food Item
//      Grants full hunger and saturation
//      Cooldown (20 Seconds)
    public golden_carrot_bucket(Material material, String name, UberRarity rarity, boolean stackable, boolean oneTimeUse, boolean hasActiveEffect, List<UberAbility> abilities, UberCraftingRecipe craftingRecipe) {
