...
public class doom_axe extends UberItem {
//    Doom Axe
//    Netherite Axe - Sharpness 10, Unbreakable, Mending, Efficiency 5
//    Steals 50% of health from damage dealt
...
//    Once crafted takes 30 minutes to drop from the location it was crafted (Text with Countdown and location displayed as a Boss Health Bar)
    public doom_axe(Material material, String name, UberRarity rarity, boolean stackable, boolean oneTimeUse, boolean hasActiveEffect, List<UberAbility> abilities, UberCraftingRecipe craftingRecipe) {
